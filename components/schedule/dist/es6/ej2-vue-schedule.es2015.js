...
let ScheduleComponent = class ScheduleComponent extends ComponentBase {
    ...
    getCellDetails(td) {
        return this.ej2Instances.getCellDetails(td);
    }
    getCellTemplate() {
...
const properties$1 = ['cssClass', 'dateFormat', 'enablePersistence', 'enableRtl', 'firstDayOfWeek', 'frequencies', 'locale', 'maxDate', 'minDate', 'selectedType', 'startDate', 'value', 'change'];
const modelProps$1 = [];
/**
