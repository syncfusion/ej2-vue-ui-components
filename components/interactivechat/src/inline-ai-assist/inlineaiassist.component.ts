 ...
 * ```
 */
export let InlineAIAssistComponent: DefineVueComponent<InlineAIAssistModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ej2Instances: new InlineAIAssist({}) as any,
...
export type InlineAIAssistComponent = typeof ComponentBase & {
...
export const InlineAIAssistPlugin = {
