 ...
 * ```
 */
export let AIAssistViewComponent: DefineVueComponent<AIAssistViewModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ej2Instances: new AIAssistView({}) as any,
...
export type AIAssistViewComponent = typeof ComponentBase & {
