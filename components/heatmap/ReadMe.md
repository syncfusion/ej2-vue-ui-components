...
* New [GitHub issue](https://github.com/syncfusion/ej2-vue-heatmap/issues/new).
...
Check the changelog [here](https://github.com/syncfusion/ej2-vue-heatmap/blob/master/CHANGELOG.md?utm_source=npm&utm_campaign=heatmap)
