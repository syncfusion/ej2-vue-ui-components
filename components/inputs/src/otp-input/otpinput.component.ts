 ...
 * ```
 */
export let OtpInputComponent: DefineVueComponent<OtpInputModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ej2Instances: new OtpInput({}) as any,
...
export type OtpInputComponent = typeof ComponentBase & {
