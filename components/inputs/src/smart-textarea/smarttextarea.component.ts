 ...
 * ```
 */
export let SmartTextAreaComponent: DefineVueComponent<SmartTextAreaModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ej2Instances: new SmartTextArea({}) as any,
...
export type SmartTextAreaComponent = typeof ComponentBase & {
...
export const SmartTextAreaPlugin = {
