 ...
 * ```
 */
export let BulletChartComponent: DefineVueComponent<BulletChartModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ...
            tagMapper: {"e-bullet-range-collection":"e-bullet-range"} as { [key: string]: Object },
            tagNameMapper: {"e-bullet-range-collection":"e-ranges"} as Object,
