...
* [**Customizing templates**](https://ej2.syncfusion.com/vue/demos/?utm_source=npm&utm_campaign=listview/#/material/listview/group-template.html) - Allows you to customize the list item, header, and category group header.
