...
export const properties: string[] = ['allowDragging', 'allowFloating', 'allowPushing', 'allowResizing', 'cellAspectRatio', 'cellSpacing', 'columns', 'draggableHandle', 'enablePersistence', 'enableRtl', 'locale', 'mediaQuery', 'panels', 'resizableHandles', 'change', 'drag', 'dragStart', 'dragStop', 'resize', 'resizeStart', 'resizeStop'];
