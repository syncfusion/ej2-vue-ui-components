...
export const properties: string[] = ['isLazyUpdate', 'plugins', 'align', 'cssClass', 'enablePersistence', 'enableRtl', 'items', 'locale', 'orientation', 'reverse', 'template', 'beforeItemRender', 'created'];
 ...
 * ```
 */
export let TimelineComponent: DefineVueComponent<TimelineModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ej2Instances: new Timeline({}) as any,
...
export type TimelineComponent = typeof ComponentBase & {
