...
var PdfViewerComponent = /** @__PURE__ @class */ (function (_super) {
    ...
    PdfViewerComponent.prototype.exportAnnotations = function (annotationDataFormat) {
        return this.ej2Instances.exportAnnotations(annotationDataFormat);
    };
    ...
    PdfViewerComponent.prototype.importAnnotations = function (importData, annotationDataFormat) {
        return this.ej2Instances.importAnnotations(importData, annotationDataFormat);
    };
