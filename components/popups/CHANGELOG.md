...
- **Smart Positioning** - Tooltip can be moved along with the mouse pointer using the mouse trailing option.## 16.1.24 (2018-02-22)
...
- **Keyboard Interaction** - The Dialog can be intractable through keyboard.## 19.1.57 (2021-04-20)
