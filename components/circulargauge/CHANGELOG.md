...
undefinedCircular Gauge component is ideal to visualize numeric values over a circular scale. The elements
...
- **User Interaction** - Supports interactive features like tooltip and pointer drag and drop.## 16.1.24 (2018-02-22)
