 ...
 * ```
 */
export let MultiColumnComboBoxComponent: DefineVueComponent<MultiColumnComboBoxModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ej2Instances: new MultiColumnComboBox({}) as any,
...
export type MultiColumnComboBoxComponent = typeof ComponentBase & {
