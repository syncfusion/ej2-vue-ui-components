 ...
 * ```
 */
export let SpeedDialComponent: DefineVueComponent<SpeedDialModel> =  vueDefineComponent({
    ...
    data() {
        return {
            ...
            tagMapper: {"e-speeddial-items":"e-speeddial-item"} as { [key: string]: Object },
            tagNameMapper: {"e-speeddial-items":"e-items"} as Object,
