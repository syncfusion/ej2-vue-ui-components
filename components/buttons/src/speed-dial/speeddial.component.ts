...
export class SpeedDialComponent extends ComponentBase {
    ...
    public tagMapper: { [key: string]: Object } = {"e-speeddial-items":"e-speeddial-item"};
    public tagNameMapper: Object = {"e-speeddial-items":"e-items"};
    public isVue3: boolean;
    public templateCollection: any;
    constructor() {
        super(arguments);
        this.isVue3 = !isExecute;
        this.ej2Instances = new SpeedDial({});        this.ej2Instances._trigger = this.ej2Instances.trigger;
