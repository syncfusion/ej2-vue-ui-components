...
var properties = ['allowValidation', 'columns', 'cssClass', 'dataSource', 'displayMode', 'enablePersistence', 'enableRtl', 'height', 'locale', 'matchCase', 'maxGroupCount', 'rule', 'showButtons', 'sortDirection', 'summaryView', 'width', 'beforeChange', 'change', 'created', 'ruleChange'];
var modelProps = [];
/**
...
var QueryBuilderComponent = /** @__PURE__ @class */ (function (_super) {
    ...
    QueryBuilderComponent.prototype.getSqlFromRules = function (rule) {
