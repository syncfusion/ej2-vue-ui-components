...
<p align="center">
  ...
  <a href="https://www.syncfusion.com/vue-components/vue-block-editor?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm">Learn more</a>
</p>
...
* [Rich text formatting](https://ej2.syncfusion.com/vue/documentation/block-editor/editor-menus?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm#inline-toolbar): Apply styles such as Bold, Italic, Underline, Strikethrough, Uppercase and more.
* [Action menu](https://ej2.syncfusion.com/vue/documentation/block-editor/editor-menus?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm#block-action-menu): Perform block-level operations such as Move, Delete, and Duplicate.
* [Contextmenu support](https://ej2.syncfusion.com/vue/documentation/block-editor/editor-menus?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm#context-menu): Right-click context menus for quick block actions.
* [Inline content support](https://ej2.syncfusion.com/vue/documentation/block-editor/built-in-blocks/inline-content?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm): Insert inline elements like Links, Labels and Mention directly within blocks.
* [Undo/Redo operations](https://ej2.syncfusion.com/vue/documentation/block-editor/undo-redo?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm): Undo and redo support for the user interactions.
* [Events for Customization](https://ej2.syncfusion.com/vue/documentation/block-editor/events?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm): The Block Editor includes a rich set of events such as block addition, removal, update, selection change, command execution, paste, and mention selection allowing developers to customize and extend functionality easily.
* **Accessibility & WCAG 2.0 Compliance**: Accessibility support for assistive technologies and keyboard navigation.
* [Keyboard Navigation](https://ej2.syncfusion.com/vue/documentation/block-editor/keyboard-shortcuts?utm_source=npm&utm_medium=listing&utm_campaign=vue-blockeditor-npm): Navigate and manage blocks efficiently using intuitive keyboard shortcuts for a faster editing experience.
