...
const properties = ['blur', 'change', 'focus', 'input', 'cssClass', 'enablePersistence', 'enableRtl', 'enabled', 'floatLabelType', 'locale', 'placeholder', 'readonly', 'showClearButton', 'type', 'value', 'created', 'destroyed'];
